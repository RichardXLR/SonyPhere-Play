...
Please follow the existing code style in the project. The project uses Kotlin and follows Android development best practices.
...
2. Update the version numbers in files to the new version that this Pull Request would represent
